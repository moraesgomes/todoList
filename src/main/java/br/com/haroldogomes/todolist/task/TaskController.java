package br.com.haroldogomes.todolist.task;
...
import br.com.haroldogomes.todolist.utils.utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (currentDate.isAfter(taskModel.getStarAt()) ||
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("a data de inicio , término e horário da task dever ser maior que a data e horário atual");
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel,
        ...
        if(!task.getIdUser().equals(idUser)){
             ...
             return ResponseEntity.status(HttpStatus.BAD_REQUEST).
              body("Usuário sem permissão para alterar essa task");
        }
